...
\Title{A sensor grid approach for large scale acoustic monitoring}
...
\corres{Correspondence: felix.gontier@reseau-eseo.fr}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=0.5\textwidth]{figures/tob_imp.eps}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=0.5\textwidth]{figures/dict_comp.eps}
