...
\pa{En fait tu as aussi des indicateurs sur le spectre, le très utilisé CGS par exemple. En fait tu devrais peut-être t'arrêter à dire que il y a pleins d'indicateurs, mais ces indics donnent de l'info sur l'env. sonore dans sa globalité, mais pas sur les sources sonores en particulier. Pourtant les sources ont de la place sur l'appréciation du soundscape (et peut-être plus que des indics globaux, par exemple 50dB de voix humaine, c'est pas la même chose que 50dB d'oiseaux). Tu peux citer la tentative dans la publi avec Catherine où on calculait le TFSD4khz qui est bien corrêlé avec les oiseaux, mais ça ne remplacera pas une vrai detection de sources. }

A simple solution is the calculation of energetic indicators for the 31 third-octave bands within the human audition range 20~Hz - 20~kHz.\\ \pa{pour des périodes très courtes (fast or slow)} This measurement appears well-suited for this work's purpose: in addition to being an efficient descriptor \cite{torija2013}, it allows for the computation of most cited indicators while representing reasonably small, fixed amounts of data to be transmitted.
 \pa{le spectrogramme en soit c'est pas un descripteur efficient, bcp trop d'info, par contre, tu as raison, avec lui on peut calculer la plupart des indicateurs cités et en plus sert pour faire de la reconnaissance. Tu peux aussi dire que du coup on fait l'impasse sur les Mel ou sur les indicateurs psychoacoustiques comme la Sonie ou le roughness. On en reparlera de vive voix si tu veux.}
...
\pa{desfois tu mets une majuscule à mel et desfois non...}
