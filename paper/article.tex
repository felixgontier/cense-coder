...
The acoustic environment represents both societal and environmental concerns, in particular for cities that are subjected to a multitude of noise sources and that count de facto numerous exposed people.

In this context, monitoring the acoustic environnment in urban but also rural or wilderness areas is an important matter. Fostering on the recent development of low cost hardware acoustic sensors, we propose to using a sensor grid approach.
...
\label{fig:codingScheme}
\end{figure}
>>>>>>> dfbee9b97a83416dbf8d61da9371361e9895a5f9
...
\multicolumn{1}{|c}{\multirow{4}{*}{Mel bands}}
 & \multicolumn{1}{|c|}{10} & 0.55$\pm$0.03 & 0.60$\pm$0.03 & 0.61$\pm$0.04 & 0.62$\pm$0.03 & 0.62$\pm$0.04 & \textbf{0.63$\pm$0.06} & \textbf{0.65$\pm$0.06} \\ \cline{2-9}
\multicolumn{1}{|c}{}
 & \multicolumn{1}{|c|}{20} & 0.58$\pm$0.04 & 0.62$\pm$0.04 & 0.63$\pm$0.04 & 0.64$\pm$0.04 & 0.63$\pm$0.04 & \textbf{0.65$\pm$0.05} & \textbf{0.67$\pm$0.06} \\ \cline{2-9}
\multicolumn{1}{|c}{}
 & \multicolumn{1}{|c|}{30} & 0.60$\pm$0.03 & 0.64$\pm$0.04 & 0.64$\pm$0.04 & \textbf{0.65$\pm$0.04} & \textbf{0.65$\pm$0.03} & \textbf{0.67$\pm$0.04} & \textbf{\textcolor{red}{0.68$\pm$0.04}} \\ \cline{2-9}
\multicolumn{1}{|c}{}
 & \multicolumn{1}{|c|}{40} & 0.60$\pm$0.03 & 0.63$\pm$0.04 & \textbf{0.64$\pm$0.04} & 0.64$\pm$0.04 & \textbf{0.64$\pm$0.04} & \textbf{0.66$\pm$0.04} & \textbf{0.68$\pm$0.05} \\ \cline{1-9}
\end{tabular}
...
\multicolumn{2}{c}{\multirow{2}{*}{RF-500}} & \multicolumn{7}{|c|}{Frames per second}\\ \cline{3-9}
 & & 2 & 4 (4.1) & 6 (6.1) & 8 (7.7) & 10 (9.5) & 20 (21) & 85 \\ \cline{1-9}
\multicolumn{1}{|c}{\multirow{4}{*}{Mel bands}}
 & \multicolumn{1}{|c|}{10} & 0.60$\pm$0.03 & 0.62$\pm$0.03 & 0.62$\pm$0.03 & 0.63$\pm$0.03 & 0.63$\pm$0.03 & \textbf{0.65$\pm$0.04} & \textbf{0.67$\pm$0.05} \\ \cline{2-9}
\multicolumn{1}{|c}{}
 & \multicolumn{1}{|c|}{20} & 0.61$\pm$0.04 & 0.63$\pm$0.03 & 0.64$\pm$0.03 & 0.64$\pm$0.03 & 0.64$\pm$0.04 & \textbf{0.66$\pm$0.06} & \textbf{0.69$\pm$0.06} \\ \cline{2-9}
\multicolumn{1}{|c}{}
 & \multicolumn{1}{|c|}{30} & 0.62$\pm$0.03 & 0.63$\pm$0.03 & 0.64$\pm$0.03 & 0.64$\pm$0.03 & 0.64$\pm$0.04 & \textbf{0.67$\pm$0.05} & \textbf{\textcolor{red}{0.69$\pm$0.06}} \\ \cline{2-9}
\multicolumn{1}{|c}{}
 & \multicolumn{1}{|c|}{40} & 0.62$\pm$0.04 & 0.63$\pm$0.04 & 0.63$\pm$0.04 & 0.64$\pm$0.04 & 0.63$\pm$0.04 & \textbf{0.67$\pm$0.06} & \textbf{0.68$\pm$0.06} \\ \cline{1-9}
\end{tabular}
...
We now compare the efficiency of third-octave bands at characterizing urban soundscapes to that of mel spectrograms. Following the previous discussions, the classification task is run on corresponding cepstra with a fixed 8 frames per second and 31 bands. Figure~\ref{fig:class_tob_q} displays similar results to the 40 bands, 8 fps mel spectrograms seen in Table~\ref{T1} for all classification schemes.\\

\begin{figure}[htbp]
	\centering
		\includegraphics[width=\columnwidth]{class_tob_q.eps}
	\caption{Classification accuracy with third-octave bands and varying word size.}
	\label{fig:class_tob_q}
\end{figure}

To further analyze both representations advantages, the confusion matrix is a reliable tool. It aims at providing information regarding class-by-class accuracy and misclassification rates. We thus compute these metrics for the SVM classifier, with predictions cumulated over the ten folds in test configuration. Results are visible in Figure~\ref{fig:tob_conf} and Figure~\ref{fig:mel_conf}. The analogous natures of the two descriptors is highlighted by close one-versus-one differentiation performances, with a slightly lower accuracy for third-octave bands on average. A noticeable difference is that on the log-frequency scale the bandwidth of mel filters narrows as frequency increases while third-octave are evenly distributed. The effect of this can be seen between classes 5 and 8 (resp. \textit{Drilling} and \textit{Jackhammer}). These sounds involve important low-frequency information which can generally differentiate them, leading third-octave descriptors to perform better. Conversely this improves globally class 1 (\textit{Air conditioning}) recognition as most of its defining components are situated in higher frequencies.\\

Each descriptor is thus found to have similar representational capabilities despite minor construction differences.
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=\columnwidth]{csii_mel_avg.eps}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=\columnwidth]{fwsnrseg_mel_avg.eps}
