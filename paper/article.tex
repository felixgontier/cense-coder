...
\begin{figure}[htbp]
	...
	\caption{Classification accuracy as a function of word size before encoding. The baseline on the right is computed without quantizing the representation. \ml{cette figure pose probleme, car la baseline n'a pas de word size, je mettrai un tick "no quant". Pourquoi les lignes continues jqa la baseline ?}}
