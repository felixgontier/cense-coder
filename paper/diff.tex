...
%DIF ADD articleV2.tex   Mon Nov 20 16:46:33 2017
...
\DIFaddbegin \DIFadd{This scheme will be implemented with a large-scale sensor grid as part of the CENSE project, where sensors are designed to be low-cost and energy efficient. The aim of the project is to create noise maps by linking standard acoustic measurements with novel perceptually motivated metrics. The presented coding scheme will enable a thorough study of the correlation between sound sources and context with pleasantness as perceived by the citizens to better understand the composition of acoustic scenes in urban environments.
}

\DIFaddend Future work will focus on the use of such a sensor grid approach as part of the \DIFdelbegin \DIFdel{Cense }\DIFdelend \DIFaddbegin \DIFadd{CENSE }\DIFaddend project where its effectiveness will be assessed in field conditions. The usefulness of more sophisticated encoding paradigms in order to further improve bitrate efficiency should also be studied\DIFaddbegin \DIFadd{, as well as the effect of multiple channel coding and its interest in sensor grids applications}\DIFaddend .
